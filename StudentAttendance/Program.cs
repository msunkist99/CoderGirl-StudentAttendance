...
namespace StudentAttendance
{
    public static class Program
    {
        public static void Main()
        {
            ...
            string[] studentsText = File.ReadAllLines(@"C:\Users\msunk\Documents\CoderGirlLC101\Lesson09 CoderGirl-StudentAttendance\CoderGirl-StudentAttendance\studentdata.txt");
